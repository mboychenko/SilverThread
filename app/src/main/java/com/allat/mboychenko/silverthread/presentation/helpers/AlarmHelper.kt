...
fun setAlarm(context: Context, millisRemaining: Long, intentAction: String, requestCode: Int, extras: Bundle? = null) {
    ...
    Log.d("NotificationTimer", "setAlarm nowMillis $nowMillis, millisRemaining $millisRemaining, requestCode $requestCode")
    Log.d("NotificationTimer", "setAlarm wakeUpTime $wakeUpTime")
...
fun setupAllatBeforeAlarm(context: Context, minsBefore: Int, allatTimezone: AllatTimeZone) {
    ...
    setAlarm(context, millisRemaining, AlarmNotificationCodes.ALLAT_BEFORE.action, AlarmNotificationCodes.ALLAT_BEFORE.code, bundle)
}
